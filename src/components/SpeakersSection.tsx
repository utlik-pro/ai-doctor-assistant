...
const speakers = [
  ...
  },
  {
    ...
    about: "Разберёт юридическую сторону вопроса, которую нельзя игнорировать: особенности обработки персональных данных в здравоохранении, использование ИИ в контексте защиты данных, ответственность врача и этические принципы ВОЗ.",
