...
const programItems = [
  ...
  },
  {
    ...
    list: [
      ...
      "Использование искусственного интеллекта в контексте защиты персональных данных",
      "Ответственность врача при использовании искусственного интеллекта",
      "Руководство ВОЗ: этические принципы и использование искусственного интеллекта в здравоохранении",
    ],
  },
];
